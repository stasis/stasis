...
*/
static inline void stasis_linear_hash_get_size_params(uint64_t desiredSize,
...
*/
static inline uint64_t stasis_linear_hash(const void * val, uint64_t val_length,
		  unsigned char tableBits, uint64_t nextExtension) {
