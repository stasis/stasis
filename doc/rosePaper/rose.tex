...
This increases the scalability of seek-bound replication and
real-time decision support and OLAP queries.
...
Existing analytical models and our benchmarks demonstrate that \rows
provides ten times as much replication bandwidth while scaling to
datasets ten times larger than than conventional techniques support.
