...
changes in business practices, system architectures, etc.

Object-oriented databases \cite{xx} are more focused on facilitating the
...
Berkeley~DB~\cite{bdb}, which provides transactional storage of data in unindexed
