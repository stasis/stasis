...
Optimization of \yad occurs in in a number of seperate phases. (Figure~\ref{fig:regres})  First, the source code is
...
APIs to efficiently handle interchangable in-memory and transactional data structures.
